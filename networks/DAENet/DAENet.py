...
from networks.DAENet.segformer import *
...
class MyDecoderLayer(nn.Module):
    def __init__(
            self, input_size, in_out_chan, head_count, token_mlp_mode, n_class=2, norm_layer=nn.LayerNorm, is_last=False
    ):
        super().__init__()
        dims = in_out_chan[0]
...
class DAEFormer(nn.Module):
    def __init__(self, num_classes=2, head_count=1, token_mlp_mode="mix_skip"):
        ...
        # Decoder
        d_base_feat_size = 12  # 16 for 512 input size, and 7 for 224
        in_out_chan = [
            [64, 128, 128, 128, 160],
            [320, 320, 320, 320, 256],
            [512, 512, 512, 512, 512],
