...
from networks.tranception.EffSegformer import *
...
class EfficientTransformerBlockFuse(nn.Module):
    ...
    def __init__(self, in_dim, key_dim, value_dim, head_count=1, token_mlp='mix'):
        ...
        self.attn = FuseEfficientAttention(in_channels=in_dim, key_channels=key_dim, value_channels=value_dim,
...
class MiT_3inception(nn.Module):
    def __init__(self, image_size, in_dim, key_dim, value_dim, layers, head_count=1, dil_conv=1, token_mlp='mix_skip',
        ...
        self.patch_embed2_1 = OverlapPatchEmbeddings_fuse(image_size // 4, patch_sizes1[1], strides[1],
                                                          dil_padding_sizes1[1], dilation, in_dim[0], in_dim[1])
        self.patch_embed2_2 = OverlapPatchEmbeddings_fuse(image_size // 4, patch_sizes2[1], strides[1],
                                                          dil_padding_sizes2[1], dilation, in_dim[0], in_dim[1])

        self.patch_embed3_1 = OverlapPatchEmbeddings_fuse(image_size // 8, patch_sizes1[2], strides[2],
                                                          dil_padding_sizes1[2], dilation, in_dim[1], in_dim[2])
        self.patch_embed3_2 = OverlapPatchEmbeddings_fuse(image_size // 8, patch_sizes2[2], strides[2],
                                                          dil_padding_sizes2[2], dilation, in_dim[1], in_dim[2])

        self.patch_embed4_1 = OverlapPatchEmbeddings_fuse(image_size // 16, patch_sizes1[3], strides[3],
                                                          dil_padding_sizes1[3], dilation, in_dim[2], in_dim[3])
        self.patch_embed4_2 = OverlapPatchEmbeddings_fuse(image_size // 16, patch_sizes2[3], strides[3],
                                                          dil_padding_sizes2[3], dilation, in_dim[2], in_dim[3])
...
class MiT_3inception_3branches(nn.Module):
    def __init__(self, image_size, in_dim, key_dim, value_dim, layers, head_count=1, dil_conv=1, token_mlp='mix_skip'):
        ...
        self.patch_embed2_2 = OverlapPatchEmbeddings_fuse(image_size // 4, patch_sizes2[1], strides[1],
                                                          dil_padding_sizes2[1], dilation, in_dim[0], in_dim[1])
        self.patch_embed2_3 = OverlapPatchEmbeddings_fuse(image_size // 4, patch_sizes3[1], strides[1],
                                                          dil_padding_sizes3[1], dilation, in_dim[0], in_dim[1])

        self.patch_embed3_1 = OverlapPatchEmbeddings_fuse(image_size // 8, patch_sizes1[2], strides[2],
                                                          dil_padding_sizes1[2], dilation, in_dim[1], in_dim[2])
        self.patch_embed3_2 = OverlapPatchEmbeddings_fuse(image_size // 8, patch_sizes2[2], strides[2],
                                                          dil_padding_sizes2[2], dilation, in_dim[1], in_dim[2])
        self.patch_embed3_3 = OverlapPatchEmbeddings_fuse(image_size // 8, patch_sizes3[2], strides[2],
                                                          dil_padding_sizes3[2], dilation, in_dim[1], in_dim[2])

        self.patch_embed4_1 = OverlapPatchEmbeddings_fuse(image_size // 16, patch_sizes1[3], strides[3],
                                                          dil_padding_sizes1[3], dilation, in_dim[2], in_dim[3])
        self.patch_embed4_2 = OverlapPatchEmbeddings_fuse(image_size // 16, patch_sizes2[3], strides[3],
                                                          dil_padding_sizes2[3], dilation, in_dim[2], in_dim[3])
        self.patch_embed4_3 = OverlapPatchEmbeddings_fuse(image_size // 16, patch_sizes3[3], strides[3],
                                                          dil_padding_sizes3[3], dilation, in_dim[2], in_dim[3])
...
class MiT(nn.Module):
    def __init__(self, image_size, in_dim, key_dim, value_dim, layers, head_count=1, token_mlp='mix_skip'):
        ...
        # patch_embed
        # layers = [2, 2, 2, 2] dims = [64, 128, 320, 512]
        self.patch_embed1_1 = OverlapPatchEmbeddings_fuse(image_size, patch_sizes1[0], strides[0],
                                                          dil_padding_sizes1[0], 3, in_dim[0])
        self.patch_embed1_2 = OverlapPatchEmbeddings_fuse(image_size, patch_sizes2[0], strides[0],
                                                          dil_padding_sizes2[0], 3, in_dim[0])

        self.patch_embed2_1 = OverlapPatchEmbeddings_fuse(image_size // 4, patch_sizes1[1], strides[1],
                                                          dil_padding_sizes1[1], in_dim[0], in_dim[1])
        self.patch_embed2_2 = OverlapPatchEmbeddings_fuse(image_size // 4, patch_sizes2[1], strides[1],
                                                          dil_padding_sizes2[1], in_dim[0], in_dim[1])

        self.patch_embed3_1 = OverlapPatchEmbeddings_fuse(image_size // 8, patch_sizes1[2], strides[2],
                                                          dil_padding_sizes1[2], in_dim[1], in_dim[2])
        self.patch_embed3_2 = OverlapPatchEmbeddings_fuse(image_size // 8, patch_sizes2[2], strides[2],
                                                          dil_padding_sizes2[2], in_dim[1], in_dim[2])

        self.patch_embed4_1 = OverlapPatchEmbeddings_fuse(image_size // 16, patch_sizes1[3], strides[3],
                                                          dil_padding_sizes1[3], in_dim[2], in_dim[3])
        self.patch_embed4_2 = OverlapPatchEmbeddings_fuse(image_size // 16, patch_sizes2[3], strides[3],
                                                          dil_padding_sizes2[3], in_dim[2], in_dim[3])
...
class Transception(nn.Module):
    def __init__(self, num_classes=2, head_count=1, dil_conv=1, token_mlp_mode="mix_skip",
                 concat='original'):  # , inception="135"
        super().__init__()
        ...
        # Decoder
        d_base_feat_size = 12  # 16 for 512 input size, and 7 for 224  384 for 12
        in_out_chan = [[32, 64, 64, 64], [144, 128, 128, 128], [288, 320, 320, 320],
                       [512, 512, 512, 512]]  # [dim, out_dim, key_dim, value_dim]
...
if __name__ == "__main__":
    ...
    print(model(torch.rand(4, 3, 384, 384)).shape)
    from torchinfo import summary

    summary(model, (torch.rand(4, 3, 384, 384)).shape)
